	...
	*/
	var defer = function (alwaysAsync){
		var alwaysAsyncFn = (undef !== alwaysAsync ? alwaysAsync : defer.alwaysAsync) ? nextTick : function(fn){fn();}
			 ...
			 * @property {function({?fulfilledCallback}, {?failedCallback}): promise} then
			 * @property {function(function): promise} sucess
			 * @property {function(): promise} error
			 * @property {function} apply
			 * @property {function} rethrow
			 * @property {function} isPending
			 * @property {function(): numeric} getStatus return one of -1 0 or 1
			 */
			, _promise  = {
